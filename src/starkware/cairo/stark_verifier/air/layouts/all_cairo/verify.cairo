...
from starkware.cairo.stark_verifier.air.layouts.all_cairo.autogenerated import (
    CONSTRAINT_DEGREE,
    MASK_SIZE,
    N_CONSTRAINTS,
    N_DYNAMIC_PARAMS,
...
from starkware.cairo.stark_verifier.air.layouts.all_cairo.composition import (
    traces_eval_composition_polynomial,
)
from starkware.cairo.stark_verifier.air.layouts.all_cairo.global_values import InteractionElements
from starkware.cairo.stark_verifier.air.layouts.all_cairo.public_verify import public_input_validate
...
func verify_proof{range_check_ptr, pedersen_ptr: HashBuiltin*, bitwise_ptr: BitwiseBuiltin*, keccak_ptr: KeccakBuiltin*}(
