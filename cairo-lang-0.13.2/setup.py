...
setuptools.setup(
    ...
    package_data={
        "starkware.cairo.bootloaders": ["*.cairo", "*/*.cairo", "*/*.py"],
        "starkware.cairo.bootloaders.simple_bootloader": ["*.cairo", "*/*.cairo", "*/*.py"],
        ...
        "starkware.cairo.stark_verifier.air.layouts.recursive_with_poseidon": ["*.cairo", "*/*.cairo"],
